...
rustPlatform.buildRustPackage rec {
  ...
  src = fetchFromGitHub {
    owner = "OpenFoxes";
    repo = "Tiny4Linux";
    rev = "9490f5c317bce1521b33aed965d683ce60744d75";
    hash = "sha256-0Rzx4lDsWPF6Wp50fiEqZ6ClWi7WusZIZOYD73KfHl8=";
  };

  cargoHash = "sha256-IBM2egyUU6U6h9RqvxqeCcq6yc16OYbBGumonGXHWxg=";
